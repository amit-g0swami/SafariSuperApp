    ...
    return(
      <SafeAreaView style={styles.contanier}>
        ...
        <View style={styles.music_logo_view}>
          <Image source={require("../../assets/images/logo2.0.jpg")} style={styles.image_view}/>
        </View>
        ...
        <View style={styles.recently_played_view}>
          ...
          <View style={styles.recently_played_list}>
            <Image source={require("../../assets/images/logo2.0.jpg")} style={styles.recently_played_image} />
